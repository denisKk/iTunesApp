...
struct Movie: Codable, Identifiable {
    ...
    static func example() -> Movie {
        Movie(wrapperType: "track", kind: "feature-movie", artistID: 1, id: 2, artistName: "Jack Johnson",
              trackName: "All At Once: On the Road Tour Documentary",
              trackCensoredName: "", artistViewURL: nil, trackViewURL: "https://music.apple.com/us/album/jack-johnson-and-friends-sing-a-longs-and/1469577723?uo=4", previewURL: nil,
